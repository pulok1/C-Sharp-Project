...
namespace Mess_Fellows
{
    public partial class Nogod : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                string query = "INSERT INTO nagad (username, amount, transectionId, date) VALUES (@username, @amount, @transectionId, @date)";
        ...
        private void Nogod_Load(object sender, EventArgs e)
        {
